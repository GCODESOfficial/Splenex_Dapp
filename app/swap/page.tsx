...
export default function Swap() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black pt-32">
      ...
      {/* Yellow card behind */}
      {/* <div className="bg-[#FED402] w-[500px] flex items-center justify-center"> */}
      ...
      <div className="bg-[#191919] text-white border border-[#FCD404] w-[380px]">
        ...
        <div className="relative pb-6 px-6 md:p-6">
        {/* Tabs */}
        <div className="absolute top-0 left-0 right-0 z-50 flex gap-2 mb-6 justify-between md:justify-start">
  {["Spot", "Limit", "Perp"].map((tab) => (
    <button
      key={tab}
      onClick={() => setActiveTab(tab as any)}
      className={`flex-1 md:flex-none px-4 py-2 text-sm font-semibold border cursor-pointer font-font-general-sans
        ${activeTab === tab
      ...
      style={
        activeTab === tab
          ...
          : {
              borderImage:
                "linear-gradient(to right, #F3DA5F 0%, #FCD404 63%) 1",
              borderImageSlice: 1,
            }
      }
    >
      {tab}
        ...
        {/* <div className="absolute top-0 z-50 flex gap-2 mb-6 justify-between md:justify-start">
          {["Spot", "Limit", "Perp"].map((tab) => (
            <button
              key={tab}
              onClick={() => setActiveTab(tab as any)}
